  ...
  return (
    <PageWrapper>
      ...
      <motion.div
        ...
        className="eco-gradient rounded-3xl p-5 text-primary-foreground mb-5 shadow-xl"
      >
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        <div className="glass-card p-3 text-center card-hover">
          <div className="w-10 h-10 mx-auto rounded-xl bg-green-50 flex items-center justify-center mb-1">
            <Recycle className="w-5 h-5 text-primary" />
          </div>
          <p className="text-lg font-bold text-foreground">{user.submissions.length + user.pickups.length}</p>
        ...
        <div className="glass-card p-3 text-center card-hover">
          ...
          <p className="text-lg font-bold text-foreground">{user.totalWasteKg}</p>
          <p className="text-[10px] text-muted-foreground">Kg Recycled</p>
        </div>
        <div className="glass-card p-3 text-center card-hover">
          <div className="w-10 h-10 mx-auto rounded-xl bg-amber-50 flex items-center justify-center mb-1">
            <Award className="w-5 h-5 text-accent" />
          </div>
          <p className="text-lg font-bold text-foreground">{user.tokens}</p>
